 ...
 * @author mcsti
 */
public class Subject_Faculty_View extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Subject_Faculty_View.class.getName());

    /**
     * Creates new form Account_Student_View
     */
    public Subject_Faculty_View() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Subject_Faculty_View().setVisible(true));
    }
