 ...
 * @author mcsti
 */
public class Schedule_Student_View extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Schedule_Student_View.class.getName());

    /**
     * Creates new form Account_Student_View
     */
    public Schedule_Student_View() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Schedule_Student_View().setVisible(true));
    }
