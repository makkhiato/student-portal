...
public class Subject_AV_ADD extends javax.swing.JDialog {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Subject_AV_ADD.class.getName());
    ...
    private void initComponents() {
        ...
        jTextSubjectDesc = new javax.swing.JTextField();
        jLabel16 = new javax.swing.JLabel();
        jTextSubjectUnits = new javax.swing.JTextField();
        ...
        jTextSubjectDesc.setFont(new java.awt.Font("Inter", 0, 14)); // NOI18N

        jLabel16.setFont(new java.awt.Font("Inter", 0, 12)); // NOI18N
        jLabel16.setText("Enter Subject Units:");

        jTextSubjectUnits.setFont(new java.awt.Font("Inter", 0, 14)); // NOI18N
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jTextSubjectDesc, javax.swing.GroupLayout.PREFERRED_SIZE, 478, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel16)
                            .addComponent(jTextSubjectUnits, javax.swing.GroupLayout.PREFERRED_SIZE, 478, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(jLabel15)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jTextSubjectDesc, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(jLabel16)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jTextSubjectUnits, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(jLabel18)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Object[] rowData = new Object[] {
            ...
            jTextSubjectDesc.getText(),
            jTextSubjectUnits.getText(),
            jComboBoxLabLec.getSelectedItem(),
            jTextCollege.getText()
        };

        Subject_Admin_View.AddRowToJTable(rowData);
        this.dispose();
    }//GEN-LAST:event_jButton1ActionPerformed

    private boolean validateInput() {
        if (jTextSubjectCode.getText().trim().isEmpty()
                || jTextSubjectDesc.getText().trim().isEmpty()
                || jTextSubjectUnits.getText().trim().isEmpty()
                || jComboBoxLabLec.getSelectedIndex() == 0
    ...
    private javax.swing.JTextField jTextSubjectDesc;
    private javax.swing.JTextField jTextSubjectUnits;
