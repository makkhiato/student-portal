 ...
 * @author mcsti
 */
public class Course_Admin_View extends javax.swing.JFrame {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Course_Admin_View.class.getName());

    /**
     * Creates new form Course_Admin_View
     */
    public Course_Admin_View() {
        initComponents();
    ...
    public void loadTable() {
        ...
        List<Course> list = dao.getCourses(search, sort);

        // 4. Define Columns
        String[] colNames = {"Course Code", "Description", "College", "Status"};

        // 5. Create Read-Only Model
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) { // Add Button
        Course_AV_ADD add = new Course_AV_ADD(this, true);
        add.setVisible(true);
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) { // Edit Button
        ...
        if (c != null) {
            Course_AV_EDIT edit = new Course_AV_EDIT(this, true);
            edit.populateData(c);
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) { // Delete Button
        ...
        String code = jTable1.getValueAt(row, 0).toString();
        int confirm = JOptionPane.showConfirmDialog(this, "Archive this course?", "Confirm", JOptionPane.YES_NO_OPTION);

        if (confirm == JOptionPane.YES_OPTION) {
            CourseDAO dao = new CourseDAO();
            if(dao.softDeleteCourse(code)) {
                JOptionPane.showMessageDialog(this, "Course archived successfully.");
                loadTable();
            } else {
                JOptionPane.showMessageDialog(this, "Error archiving course.");
            }
        }
    }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) { loadTable(); } // Already here
    ...
    private void jButton4MouseEntered(java.awt.event.MouseEvent evt) { /* Current Page */ }
    private void jButton4MouseExited(java.awt.event.MouseEvent evt) { /* Current Page */ }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new DefaultTableModel(
                ...
                new String [] {
                        "Course Code", "Description", "Status", "College"
                }
        ));
        jScrollPane1.setViewportView(jTable1);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Course_Admin_View().setVisible(true));
    }
